...
import {
  MessageType,
  type MessageTypes,
} from '../interfaces.enums/database.enums';
...
export class Message extends BaseEntity {
  ...
  @JoinColumn({
    name: 'senderId',
    foreignKeyConstraintName: 'FK_user_messages',
  })
  sender: User;
  ...
  @JoinColumn({
    ...
    foreignKeyConstraintName: 'FK_message_messages',
  })
  replyToMessage: Message;

  @OneToOne(() => UserNotification, (notification) => notification.message, {
    nullable: true,
  })
